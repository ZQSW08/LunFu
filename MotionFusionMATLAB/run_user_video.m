...
%% 3. 宏观运动参考
u.referenceModel='translation'; % translation / similarity(至少两个参考) / none
...
u.targetMode='profile';       % direct一致目标配准 / profile旧方法 / consensus实验 / texture双向
u.referenceTracker='anchor';   % flow双向光流参考 / anchor旧固定模板
